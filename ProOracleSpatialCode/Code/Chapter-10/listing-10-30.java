...
public class LinkLevelConstraint implements NetworkConstraint {
  int p_targetLevel = 0; // Default; no restriction

  public LinkLevelConstraint (int targetLevel) {
    p_targetLevel = targetLevel;
  }
